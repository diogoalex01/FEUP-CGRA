...
class MyTangram extends CGFobject {
    constructor(scene) {
        ...
        this.scene.smalltriangle1 = new MyTriangleSmall(this.scene);
        this.scene.bigtriangle1 = new MyTriangleBig(this.scene);
        this.scene.smalltriangle2 = new MyTriangleSmall(this.scene);
        this.scene.bigtriangle2 = new MyTriangleBig(this.scene);
    ...
    initMaterials() {
        ...
        this.diamondMaterial.setTexture(this.textureDiamond);
