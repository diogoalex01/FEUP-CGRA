...
class MyInterface extends CGFinterface {
    ...
    init(application) {
        ...
        sf0.add(this.scene.lights[0].position, '1', -5.0, 5.0).name("X Position");
        sf0.add(this.scene.lights[0].position, '2', -5.0, 5.0).name("Y Position");
        sf0.add(this.scene.lights[0].position, '3', -5.0, 5.0).name("Z Position");
        ...
        sf1.add(this.scene.lights[1].position, '1', -5.0, 5.0).name("X Position");
        sf1.add(this.scene.lights[1].position, '2', -5.0, 5.0).name("Y Position");
        sf1.add(this.scene.lights[1].position, '3', -5.0, 5.0).name("Z Position");
